        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (content.trim().length <= 0 ||
                    ...
                    postId <= 0 ||
                    userId <= 0) {
                    res.status(constant_1.CODE.BAD_REQUEST).json((0, helpers_1.responseData)(null, 'Value is valid', constant_1.CODE.BAD_REQUEST, true));
                }
                const comment = yield CommentService_1.default.addComment(content, userId, postId);
                return res
                    .status(constant_1.CODE.SUCCESS)
                    .json((0, helpers_1.responseData)(comment, 'Comment success'));
            }
            catch (error) {
                const err = error;
                return res

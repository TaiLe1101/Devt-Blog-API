    ...
    constructor() {
        this.verifyToken = (req, res, next) => {
            ...
            if (token) {
                ...
                return res
                    .status(constant_1.CODE.BAD_REQUEST)
                    .json((0, helpers_1.responseData)(null, "You're not Authorization", constant_1.CODE.BAD_REQUEST, true));
            }
        };
        this.verifyTokenAndAdminAuth = (req, res, next) => {
            this.verifyToken(req, res, () => {
                ...
                if (((_a = req.user) === null || _a === void 0 ? void 0 : _a.id) === Number(req.params.id)) {
                    ...
                    res.status(constant_1.CODE.BAD_REQUEST).json((0, helpers_1.responseData)(null, 'You not permission', constant_1.CODE.BAD_REQUEST, true));
                }
            });
        };
    }
